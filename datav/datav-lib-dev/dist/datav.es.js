import { computed, pushScopeId, popScopeId, openBlock, createBlock, createCommentVNode, createVNode, renderSlot, withScopeId, ref, onMounted, getCurrentInstance, onUnmounted, nextTick, resolveComponent, toDisplayString } from 'vue';
...
var render$5 = /*#__PURE__*/_withId$4(function (_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock("div", _hoisted_1$4, [_hoisted_2$3, _hoisted_3$2, createVNode("div", _hoisted_4, [createVNode(_component_CountTo, {
    ...
    endVal: 2017,
    duration: 4000
  }), createCommentVNode(" 今日温度{{`${todaysTemperature}°`}} ")]), createVNode("div", _hoisted_5, [createVNode("span", _hoisted_6, " 昨日温度" + toDisplayString("".concat($props.yesterdayTemperature, "\xB0")), 1
  /* TEXT */
  ), createVNode("span", _hoisted_7, " 同比增长" + toDisplayString("".concat($props.growthRate, "%")), 1
  /* TEXT */
  )])]);
});
